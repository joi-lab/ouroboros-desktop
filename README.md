...
| 4.15.2 | 2026-04-07 | Cloud.ru Foundation Models onboarding: first-run wizard now accepts a Cloud.ru API key with built-in `https://foundation-models.api.cloud.ru/v1` endpoint and prefills `cloudru::zai-org/GLM-4.7` across all four model lanes. Cherry-picked from PR #14. |
